...
import SearchDropDownList from "./index";

let closeResults = false;
let products = [
  {
...
describe("SearchDropDownList component", () => {
  it("SearchDropDownList component render", () => {
    const wrapper = shallow(
      <SearchDropDownList closeResults={closeResults} products={products} />
    );
